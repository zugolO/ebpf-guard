...
if [ "${_w63l1_agg_on:-000}" = "503" ]; then
    ...
    if command -v dig >/dev/null 2>&1; then
        _w63l1_agg_shots=$(( _w63l1_ab / 8 ))
        [ "$_w63l1_agg_shots" -gt 5 ] && _w63l1_agg_shots=5
        [ "$_w63l1_agg_shots" -lt 1 ] && _w63l1_agg_shots=1
        ...
        echo "  положительный случай: $_w63l1_agg_shots подач dig на $_w63l1_agg_qname с интервалом 8с (дедуп 5с обойдён)"
        _w63l1_i=0
