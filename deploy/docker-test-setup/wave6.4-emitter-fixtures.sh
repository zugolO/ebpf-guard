...
echo "СТОРОЖ ЭМИТТЕРОВ ПРОЙДЕН: 14 фикстур 6.4.x + 4 фикстуры классов 6.4.4 (№455) + 13 фикстур 6.4.B (включая именованный состав оси, №458) + два сторожа №373 + 6 проверок достижимости, расхождений 0"
