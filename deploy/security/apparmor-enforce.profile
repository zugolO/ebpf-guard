# AppArmor profile for ebpf-guard (ENFORCE MODE)
# This profile allows the minimum required permissions for ebpf-guard to function
# 
# To apply this profile:
#   sudo apparmor_parser -r -W deploy/security/apparmor-enforce.profile
#
# To check status:
#   sudo aa-status | grep ebpf-guard
#
# To rollback to complain mode:
#   sudo aa-complain /etc/apparmor.d/ebpf-guard

#include <tunables/global>

profile ebpf-guard flags=(attach_disconnected, mediate_deleted, enforce) {
