// Package autolearn provides behavioral profiling for automatic rule generation.
package autolearn

import "fmt"

// syscallNames maps Linux x86_64 syscall numbers to their string names.
// Used when generating seccomp profiles and human-readable rule descriptions.
...
// SyscallName returns the name for a syscall number, or a fallback.
