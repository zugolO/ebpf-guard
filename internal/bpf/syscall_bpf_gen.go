...
// sys_enter_sendmmsg, sys_enter_write, sys_enter_writev,
// sys_enter_recvmsg/sys_exit_recvmsg, sys_enter_read/sys_exit_read, and
// sys_enter_recvfrom/sys_exit_recvfrom (connected-UDP-socket I/O — the
// sendmmsg()/recvmsg() path is what glibc's stub resolver, and therefore
// `dig`, actually uses), and write events into the dedicated dns_events
// ring buffer.
...
func (o *DNSObjects) Close() error {
	for _, p := range []*ebpf.Program{
		...
		o.TraceSendmmsg, o.TraceWrite, o.TraceWritev,
		o.TraceRecvmsgEnter, o.TraceRecvmsgExit,
		o.TraceReadEnter, o.TraceReadExit,
