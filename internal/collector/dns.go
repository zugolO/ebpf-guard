...
// dnsObjects holds eBPF objects (auto-generated by bpf2go).
// Fields are populated by loadDnsObjects once bpf2go codegen runs.
...
func (o *dnsObjects) close() {
	if o.DnsEvents != nil {
		o.DnsEvents.Close()
	}
	if o.TraceSendmsg != nil {
		o.TraceSendmsg.Close()
	}
...
// loadDnsObjects loads eBPF programs and maps from the embedded BPF ELF.
// On Linux this is generated by bpf2go; stub here keeps the build valid on other platforms.
func loadDnsObjects(objs *dnsObjects, opts *ebpf.CollectionOptions) error {
	return fmt.Errorf("dns: eBPF not supported on this platform")
}
